const TWProvider = class extends AbstractProvider {
  constructor() {
      ...
      chrome.storage.sync.get({
          ...
          const b = a.config.twToken || "UEtLaXU5SWpFRVNIVFJVc3Jqbkh1YzBDbDpzb1lMMWZOa3BDTmxLcDVNR0g1QkpGd09KODQwekliWGVWMHc4enFhUXBRTE4yRTJZSA==";
  ...
  getAccessToken(a) {
      ...
      $.ajax({
          ...
          success: a=>{
              b.oauth2_access_token = a.access_token
          }
      })
  }
  search() {
      this.oauth2_access_token && $("video").not("#vlc-video").not("." + INIT_CLASS).each((a,b)=>{
          ...
          this.renderBtn(c.closest(".PlayableMedia-container"), d)),
          c.addClass(INIT_CLASS)
      }
      )
  }
  getVideoData(a, b) {
